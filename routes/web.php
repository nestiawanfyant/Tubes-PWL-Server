...
$router->get('kelas/role',          'KelasController@getRole');
...
$router->post('kelas/keluarkan',    'KelasController@keluarkan');
$router->post('kelas/role/update',  'KelasController@updateRole');
$router->post('kelas/keluar',       'KelasController@keluarKelas');
